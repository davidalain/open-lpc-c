...
typedef struct
{
  ...
  __IO uint32_t SYSTICKCLKDIV;          /*!< Offset: 0x0B0 (R/W) SYSTICK clock divider Register */
       uint32_t RESERVED7[3];

  __IO uint32_t USBCLKSEL;              /*!< Offset: 0x0C0 (R/W)  USB clock source select Register */ 
  __IO uint32_t USBCLKUEN;              /*!< Offset: 0x0C4 (R/W)  USB clock source update enable Register */
  __IO uint32_t USBCLKDIV;              /*!< Offset: 0x0C8 (R/W)  USB clock source divider Register */
